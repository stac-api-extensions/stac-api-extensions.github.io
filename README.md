...
| [Multi-Tenant Catalogs Endpoint](https://github.com/StacLabs/multi-tenant-catalogs)* | STAC API - Core | *Unknown* | 1.0.0-rc.1 | STAC API Extension to support Multi-Catalog hierarchies via a dedicated /catalogs endpoint. (Recursive Tree architecture). |
...
- **Last updated:** Jun 08 2026, 02:50 UTC
- **Count:** 19
