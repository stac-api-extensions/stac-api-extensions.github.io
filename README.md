...
| Title | Scope | [Maturity](https://github.com/radiantearth/stac-spec/tree/master/extensions#extension-maturity) | Version | Description |
| ----- | ----- | ----------------------------------------------------------------------------------------------- | ------- | ----------- |
...
| [Children](https://github.com/stac-api-extensions/children) | STAC API - Core | Proposal | 1.0.0 | The purpose of this extension is to add an endpoint that presents a single resource from which clients can retrieve the immediate children of a Catalog. |
...
| [Multi-Tenant Catalogs Endpoint](https://github.com/StacLabs/multi-tenant-catalogs)* | STAC API - Core | *Unknown* | 1.0.0 | STAC API Extension to support Multi-Catalog hierarchies via a dedicated /catalogs endpoint. (Recursive Tree architecture). |
...
- **Last updated:** Sep 22 2026, 02:39 UTC
- **Count:** 19
