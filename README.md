...
| [Multi-Tenant Catalogs Endpoint](https://github.com/Healy-Hyperspatial/multi-tenant-catalogs)* | STAC API - Core | *Unknown* | 1.0.0-beta.1 | Extension to support Multi-Catalog STAC hierarchies via a dedicated /catalogs endpoint. (Recursive Tree architecture). |
...
- **Last updated:** Feb 23 2026, 01:23 UTC
- **Count:** 19
