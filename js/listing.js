(async () => {
  ...
  const response = await fetch(`https://api.github.com/repos/stac-api-extensions/${repo}/git/trees/gh-pages?recursive=true`);
  ...
  let htmlString = `<h1>STAC API Extension '${repo}' Schemas</h1><ul>`;
